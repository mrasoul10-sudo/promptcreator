...
- محدودیت‌ها: ورود با گوگل داخل اپ در دسترس نیست (گوگل ورود در WebView را مجاز نمی‌داند)؛ ورود با ایمیل کار می‌کند. تبدیل گفتار به متن در WebView اندروید پشتیبانی نمی‌شود و دکمه میکروفون در اپ نمایش داده نمی‌شود. اطلاعات اپ از مرورگر گوشی جداست؛ برای انتقال از «پشتیبان‌گیری» استفاده کنید.
